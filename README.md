...
kaggle_cleaned.csv: Evolución salarial histórica (2020-2026).
encuesta_sysarmy_20261_CSV.csv: Ajustes regionales y modalidades.
encuesta_stackoverflow_2025_CSV.csv: Estructuras de roles y volumen de demanda.
github_repos_real.csv: Cuantificación de competencias técnicas y lenguajes.
